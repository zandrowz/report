...
{
    /**
     * @Route("excercises/dice/graphic", name="dice-graphic-home")
     */
    public function home(): Response
    {
        ...
        return $this->render('excercises/dice/home.html.twig', $data);
    }

    /**
     * @Route("excercises/dice/grahpic/roll/{numRolls}", name="dice-graphic-roll")
     */
    public function roll(int $numRolls): Response
    {
        ...
        return $this->render('excercises/dice/roll.html.twig', $data);
    }
}
